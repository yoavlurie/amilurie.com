...
var DuelHeroDefs = (function () {
  ...
  var roster = [
    { id: "percy", name: "Percy Jackson", series: "pjo", desc: "Son of Poseidon. Water powers.",
      specialName: "Water Wave", specialId: "percy_water_wave", specialCharges: 3,
      stats: { hp: 100, atk: 12, def: 6, speed: 160 }, color: "#2a6496", unlocked: true },
    { id: "annabeth", name: "Annabeth Chase", series: "pjo", desc: "Daughter of Athena. Strategist.",
      specialName: "Strategic Strike", specialId: "annabeth_strategic", specialCharges: 3,
      stats: { hp: 90, atk: 14, def: 5, speed: 170 }, color: "#c0c0d0", unlocked: true },
    ...
    { id: "magnus", name: "Magnus Chase", series: "mc", desc: "Son of Frey. Einherji healer.",
      specialName: "Heal Burst", specialId: "magnus_heal", specialCharges: 4,
      stats: { hp: 110, atk: 10, def: 7, speed: 150 }, color: "#2a8a4e", unlocked: true },

...
var DuelEnemyDefs = (function () {
  ...
  var raw = [
    ...
    ["kelli","Kelli","The Empousa",50,7,2,100,"basic",0.9,1.8,0.7,"Fast but fragile — stay aggressive","manhattan",2,"charmspeak_enemy",1],
    ["antaeus","Antaeus","Son of Gaea",75,8,4,55,"heavy",1.1,2.2,1.0,"Lift him off the ground — attack from platforms","underworld",2,"earth_quake",2],
